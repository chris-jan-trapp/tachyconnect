...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.dialect_selecto = QtWidgets.QComboBox(self.centralwidget)
        self.dialect_selecto.setObjectName("dialect_selecto")
        self.horizontalLayout.addWidget(self.dialect_selecto)
